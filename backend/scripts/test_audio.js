...
async function test() {
  try {
    ...
    console.log('\nClearing audio URLs, speaker_character, emotion, and audio translations for shloka 1 to force classification & regeneration...');
    await db.query('UPDATE ramayana_shlokas SET speaker_character = NULL, emotion = NULL, audio_sanskrit_url = NULL, audio_hindi_url = NULL, audio_english_url = NULL, audio_translation_hi = NULL, audio_translation_en = NULL WHERE id = 1');

    console.log('\nGenerating Sanskrit audio (which triggers speaker & emotion classification)...');
    ...
    console.log('\nQuerying shloka 1 details again to verify cached speaker, emotion, and audio URL...');
